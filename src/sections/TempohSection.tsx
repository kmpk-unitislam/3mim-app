...
export default function TempohSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Main 3 Days Number blink and glow
      const mainThreeText = sectionRef.current?.querySelector('.animate-main-3');
      if (mainThreeText) {
        gsap.to(mainThreeText, {
          scale: 1.3,
          opacity: 0.5,
          ...
          yoyo: true,
          ease: 'power1.inOut',
          delay: 1, // Start after other animations settle
        });
      }
    }, sectionRef);
                ...
                <div className="flex items-center justify-center gap-4 flex-wrap">
                  ...
                  <div className="text-center">
                    <div className="w-12 h-12 bg-teal/10 rounded-full flex items-center justify-center mb-2 border border-teal/20">
                      <span className="text-lg font-display font-bold text-teal">1</span>
                    </div>
                  ...
                  {/* 3 Days Highlighted */}
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gradient-to-br from-teal to-teal-light rounded-full flex items-center justify-center mb-2 shadow-glow-teal">
                      <span className="animate-main-3 inline-block text-2xl font-display font-bold text-white">
                        3
                      </span>
                    </div>
