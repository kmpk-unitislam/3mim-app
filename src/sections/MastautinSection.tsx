          ...
          <div className="text-center lg:text-left">
            ...
            <div ref={titleRef} className="opacity-0 flex items-center justify-center lg:justify-start gap-4 mb-4">
              ...
              <div className="relative mt-2 md:mt-0">
                <div className="absolute -top-[4.5rem] left-[60%] sm:left-[70%] -translate-x-1/2 flex flex-col items-center pointer-events-none md:scale-100 scale-75 origin-bottom-left animate-bounce">
                  ...
                  <HandDrawnArrow className="w-10 h-10 text-teal -ml-8 -mt-2 drop-shadow-sm" />
                </div>
                <button
                  onClick={() => {
                    if (audioRef.current) {
