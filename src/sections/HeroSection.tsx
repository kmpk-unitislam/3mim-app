      ...
      >
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto perspective-1000">
          ...
          <div className="mb-6 flex justify-center">
            <div className="w-16 h-16 rounded-full bg-gold/20 flex items-center justify-center animate-icon-pulse">
          ...
          <h1
            ref={titleRef}
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold text-white mb-6 preserve-3d"
          >
          ...
          <p
            ref={subtitleRef}
            className="text-xl sm:text-2xl md:text-3xl text-gold-light font-display mb-6 opacity-0"
          >
          ...
          <p
            ref={descRef}
            className="text-base sm:text-lg text-white/80 max-w-2xl mx-auto leading-relaxed opacity-0"
          >
        ...
        <div
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 text-center cursor-pointer opacity-0"
