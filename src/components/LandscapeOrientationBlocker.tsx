  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-teal flex flex-col items-center justify-center text-white p-6 text-center shadow-2xl">
      ...
      <button 
        ...
        className="mt-8 px-6 py-3 bg-gold/90 hover:bg-gold text-teal-900 font-bold rounded-full shadow-lg transition-transform hover:scale-105 active:scale-95 flex items-center gap-2"
      >
